...
const QString CONFFILE      = "E:/CCdoe/QT/yundisk/conf/cfg.json";     // 配置文件
const QString  RECORDDIR    = "E:/CCdoe/QT/yundisk/conf/record/";      // 用户文件上传下载记录
const QString  FILETYPEDIR  = "E:/CCdoe/QT/yundisk/conf/fileType";     // 存放文件类型图片目录
